...
/*
 * This scece shows the browsing file of roads scene
 */
public class BrowseRoadsFileScene {
	//fields
	 ...
	 * @param stage
	 */
	public BrowseRoadsFileScene(Stage stage) {
      initialize(stage);
    }
    ...
    public void initialize(Stage stage) {
		...
		//Greeting Label
		label = new Label("   	Now browse for your roads file...");
		...
		stage.setTitle("Browse for the roads file");
